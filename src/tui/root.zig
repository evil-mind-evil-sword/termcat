...
const console_mod = @import("ConsoleOverlay.zig");
pub const ConsoleOverlay = console_mod.ConsoleOverlay;
pub const ConsoleOverlayOptions = console_mod.Options;
pub const ConsoleOverlayPosition = console_mod.Position;
pub const installConsoleOverlay = console_mod.installGlobal;
pub const uninstallConsoleOverlay = console_mod.uninstallGlobal;
pub const consoleLogFn = console_mod.logFn;
pub const ConsoleOverlayStdIoCapture = console_mod.StdIoCapture;
pub const ConsoleOverlayCopyHandler = console_mod.CopyHandler;
