...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("termcat", .{
        ...
        .target = target,
        // Link libc for PTY functions (grantpt, unlockpt, ptsname)
        .link_libc = true,
    });
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "termcat" is the name you will use in your source code to
                // import this module (e.g. `@import("termcat")`). The name is
    ...
    const examples = [_]struct { name: []const u8, path: []const u8 }{
        ...
        .{ .name = "input_reader_test", .path = "examples/input_reader_test.zig" },
